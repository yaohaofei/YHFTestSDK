...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "yaohaofei" => "313888178@qq.com" }
  # Or just: spec.author    = "yaohaofei"
  # spec.authors            = { "yaohaofei" => "313888178@qq.com" }
  # spec.social_media_url   = "https://twitter.com/yaohaofei"
  ...
  spec.source_files  = "YHFTestSDK", "YHFTestSDK/*.{h,framework}"
